...
class User(db.Model, UserMixin):
    ...
    fitness_plan_height_cm = db.Column(db.Float, nullable=True)
    fitness_plan_weight_kg = db.Column(db.Float, nullable=True)
    fitness_plan_goal_key = db.Column(db.String(50), nullable=True)
    fitness_plan_updated_at = db.Column(db.DateTime, nullable=True)
